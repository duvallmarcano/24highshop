...
inStock: true
shop: "healthshop"
category: "focus-amp-concentration"
...
<p>At 24High, we believe it is important that botanical products are clearly explained. Want to learn more about the difference between extracts and tinctures? Read our blog:  <a href="/en/blog/whats-the-difference-between-a-tincture-and-an-extract">What is the difference between a tincture and an extract?</a>.</p>
...
<p>In addition to blue lotus, there are various botanical extracts with their own traditional background. Also explore other products in the  <a href="/en/shop/smartshop/tinctures">tinctures and extracts</a> category if you want to compare alternatives.</p>
