---
title: "White Rabbit Mushroom Spawn - 24High"
...
<script>
    ...
    dataLayer.push({
        event: "view_item",
        ecommerce: {"items":[{"quantity":1,"price":24.95,"item_name":"White Rabbit Paddo Broed","item_id":"5201165"}],"currency":"EUR","value":24.95}    });
...
<script type="application/ld+json">
    {
        ...
        "@type": "Product",
        "name": "White Rabbit Mushroom Spawn",
        "image": "https://www.24high.com/images/articles/image.php?id=5091&w=300&h=300",
        "description": "The White Rabbit mushroom spawn is a unique albino variety of Psilocybe Cubensis, created from a cross between two popular strains: Albino Penis Envy and Moby Dick. This particular strain is known for its large, white hats and stems, although a hint of pigment is quite normal. The strength is medium, making it perfect for novice growers as well as curious psychonauts who don't want to jump straight into the deep end.\nWhat is a Paddobrood?\nPaddobrood, also known as grain spawn, is grain that is fully grown through with mycelium. This forms the basis for successful mushroom cultivation. In ready-made grow kits, this spawn is often already mixed with coconut soil and vermiculite, packed in a fixed quantity. Such a grow kit yields a limited harvest and cannot be reused afterwards. Working with loose mushroom spawn yourself gives you much more control and flexibility. You easily determine the size of your cultivation and can also multiply the mycelium. This is because the strong mycelium grows quickly and vigorously: you can make several new portions from one jar of mushroom spawn. So you scale up your cultivation from 1 to 10, to 100 pots - all within a few weeks. So you are no longer stuck with a standard 250, 1200 or 2100 ml grow kit, but grow exactly the amount of mushrooms you want. And the best part? This is achievable for everyone, just with everyday items from home.\nFeatures\n\nAlbino Psilocybe Cubensis (cross between Albino Penis Envy and Moby Dick)\nGrows into large white mushrooms\nMedium strength, ideal for beginners\nMore freedom than a standard grow kit\nMycelium grows exponentially: infinite growing possibilities\n\nIngredients and composition\n\n382 ml of mushroom spawn from White Rabbit\nGrain-based mycelium\n\nUse\nWhite Rabbit mushroom spawn is intended for the home grower who wants to control the size of their grow. Unlike fixed grow kits, spawn gives you the freedom to decide how big your grow becomes and how often you multiply it. With simple household utensils, you can already get started, without the need to be sterile. Each jar comes with a clear manual, packed with photos and step-by-step plans for different growing methods.\nDOWNLOAD HERE: Paddobrood Instructions \/ Manual\nContents\n\n382 ml White Rabbit mushroom spawn\nDetailed cultivation manual\n\nImportant\n\nStore in the fridge, shelf life up to 3 months\nDo not open jar before use\nAlways read the manual first\n",
         "brand": {
                "@type": "Brand",
                "name": "mystic fungi"
            },
        ...
        "offers": {
            ...
            "url": "https://www.24high.com/en/article/5201165-white-rabbit-mushroom-spawn?setlang=en&article=5201165-white-rabbit-mushroom-spawn",
            "seller": {
                "@type": "Organization",
                "name": "24High"
            }
...
<div class="content">
<h1 class="h1 h1--line" style="color: rgb(101,101,101);">White Rabbit Mushroom Spawn</h1>
...
<img alt="White Rabbit Mushroom Spawn" class="imagebox__mainimage" id="main-product-image" src="../../images/articles/image.php@id=5091&amp;w=1000&amp;h=1000">
<div id="interactive-viewer-container" style="display: none; width: 100%; height: 100%;"></div>
</img></div>
<div class="imagebox__thumbscontainer">
<div class="imagebox__thumbnail" data-url="https://www.24high.com/images/articles/image.php?id=5091&amp;w=1000&amp;h=1000"> <img alt="" src="../../images/articles/image.php@id=5091&amp;w=200&amp;h=200"/></div><div class="imagebox__thumbnail" data-url="https://www.24high.com/images/articles/image.php?id=5090&amp;w=1000&amp;h=1000"> <img alt="" src="../../images/articles/image.php@id=5090&amp;w=200&amp;h=200"/></div><div class="imagebox__thumbnail" data-url="https://www.24high.com/images/articles/image.php?id=5093&amp;w=1000&amp;h=1000"> <img alt="" src="../../images/articles/image.php@id=5093&amp;w=200&amp;h=200"/></div> </div>
</div>
</div>
<div class="columns__column columns__column--grow" style="padding-left: 10px;">
<div class="fx fx--ai-center">
<a class="a a--hover-primary fx__i" href="5201165-white-rabbit-mushroom-spawn.html#" onclick="$('#reviewtabbtn').click().get(0).scrollIntoView();
...
<div class="fx__i">Article number: 5201165</div>
</div>
<br/>
<div id="articlePrice">
<span class="text-bold font-2x">€ 24,95</span> (Incl.VAT)            </div>
<br/><br/>
<div class="ftable ftable--on-white ftable--secondary"><div class="ftable__row"><div class="ftable__cell">Buy 2 items</div><div class="ftable__cell">For € 24,45 Each</div></div><div class="ftable__row"><div class="ftable__cell">Buy 3 items</div><div class="ftable__cell">For € 23,95 Each</div></div><div class="ftable__row"><div class="ftable__cell">Buy 4 items</div><div class="ftable__cell">For € 23,45 Each</div></div><div class="ftable__row"><div class="ftable__cell">Buy 5 items</div><div class="ftable__cell">For € 22,95 Each</div></div></div>
<br>
<div id="articleStockStatus"><i class="fa fa-times danger"></i> Currently not available</div>
<br/>
<select class="input hidden" id="selectVariant" name="variation"><option value="5201165">White Rabbit Mushroom Spawn</option></select>
<div class="fx">
...
<div class="tabs__button" data-tabscontent="#tabs_1792"><i class="far fa-info-circle fa-fw"></i> Disclaimer</div> <div class="tabs__button tabs__button--secondary" data-tabscontent="#tabs_reviews" id="reviewtabbtn"><i class="fas fa-star fa-fw"></i> Reviews</div>
</div>
<div class="tabs__content" id="tabs_description" style="padding: 10px;">
<p>The <strong>White Rabbit mushroom</strong> <strong>spawn </strong>is a unique albino variety of Psilocybe Cubensis, created from a cross between two popular strains: Albino Penis Envy and Moby Dick. This particular strain is known for its large, white hats and stems, although a hint of pigment is quite normal. The strength is medium, making it perfect for novice growers as well as curious psychonauts who don't want to jump straight into the deep end.</p>
<h3>What is a Paddobrood?</h3>
<p>Paddobrood, also known as grain spawn, is grain that is fully grown through with mycelium. This forms the basis for successful mushroom cultivation. In ready-made grow kits, this spawn is often already mixed with coconut soil and vermiculite, packed in a fixed quantity. Such a grow kit yields a limited harvest and cannot be reused afterwards. Working with loose mushroom spawn yourself gives you much more control and flexibility. You easily determine the size of your cultivation and can also multiply the mycelium. <br/><br/>This is because the strong mycelium grows quickly and vigorously: you can make several new portions from one jar of mushroom spawn. So you scale up your cultivation from 1 to 10, to 100 pots - all within a few weeks. So you are no longer stuck with a standard 250, 1200 or 2100 ml grow kit, but grow exactly the amount of mushrooms you want. And the best part? This is achievable for everyone, just with everyday items from home.</p>
<h3>Features</h3>
<ul>
<li>Albino Psilocybe Cubensis (cross between Albino Penis Envy and Moby Dick)</li>
<li>Grows into large white mushrooms</li>
<li>Medium strength, ideal for beginners</li>
<li>More freedom than a standard grow kit</li>
<li>Mycelium grows exponentially: infinite growing possibilities</li>
</ul>
<h3>Ingredients and composition</h3>
<ul>
<li>382 ml of mushroom spawn from White Rabbit</li>
<li>Grain-based mycelium</li>
</ul>
<h3>Use</h3>
<p>White Rabbit mushroom spawn is intended for the home grower who wants to control the size of their grow. Unlike fixed grow kits, spawn gives you the freedom to decide how big your grow becomes and how often you multiply it. With simple household utensils, you can already get started, without the need to be sterile. Each jar comes with a clear manual, packed with photos and step-by-step plans for different growing methods.</p>
<p><strong>DOWNLOAD HERE: </strong><span style="color: #0907f5;"><a href="../files/index.html@id=2363.pdf&amp;file=Handleiding+Grain+Spawn+ENGELS.pdf" rel="noopener" style="color: #0907f5; text-decoration: underline;" target="_blank">Paddobrood Instructions / Manual</a></span></p>
<h3>Contents</h3>
<ul>
<li>382 ml White Rabbit mushroom spawn</li>
<li>Detailed cultivation manual</li>
</ul>
<h3>Important</h3>
<ul>
<li>Store in the fridge, shelf life up to 3 months</li>
<li>Do not open jar before use</li>
<li>Always read the manual first</li>
</ul> </div>
<div class="tabs__content" id="tabs_1792" style="padding: 10px;"><p>The contents of this text are for informational purposes only and are not a substitute for professional advice. This product is not a medicine and is not intended to diagnose, treat or cure any medical condition. Please consult a specialist with any specific questions regarding the use of this product. Some scientific studies on the effects of this product are ongoing and not all claims have been definitively confirmed.</p></div>
