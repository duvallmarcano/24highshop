---
title: "Precision Industrial Scale 12 Kg X 1 Gr. - 24High"
...
<script>
    ...
    dataLayer.push({
        event: "view_item",
        ecommerce: {"items":[{"quantity":1,"price":469.95,"item_name":"Precision Industrial Scale 12 Kg X 1 Gr.","item_id":"9108146"}],"currency":"EUR","value":469.95}    });
...
<script type="application/ld+json">
    {
        ...
        "@type": "Product",
        "name": "Precision Industrial Scale 12 Kg X 1 Gr.",
        "image": "https://www.24high.com/images/articles/image.php?id=1548&w=300&h=300",
        "description": "This very robust bench scale has a maximum capacity of 12 kilograms and an accuracy of 1 gram. Can be used as a package, count, recipe and check scale. The LCD display can either be mounted on the platform, or be set up separately from the scale with a 1.5 m spiral cable, or can be permanently installed with the included wall holder.Color: silverAccuracy: 1 gramMaximum weighing capacity: 12 kilograms",
         "sku": "9108146",
        "gtin13": "",
        "mpn": "5160383",
        "offers": {
            ...
            "url": "https://www.24high.com/en/article/9108146-precision-industrial-scale-12-kg-x-1-gr?setlang=en&article=9108146-precision-industrial-scale-12-kg-x-1-gr",
            "seller": {
                "@type": "Organization",
                "name": "24High"
            }
...
<div class="content">
<h1 class="h1 h1--line" style="color: rgb(101,101,101);">Precision Industrial Scale 12 Kg X 1 Gr.</h1>
<div class="columns columns--mobile800">
<div class="columns__column">
<div class="imagebox">
<div class="imagebox__maincontainer">
<img alt="Precision Industrial Scale 12 Kg X 1 Gr." class="imagebox__mainimage" id="main-product-image" src="../../images/articles/image.php@id=1548&amp;w=1000&amp;h=1000">
<div id="interactive-viewer-container" style="display: none; width: 100%; height: 100%;"></div>
</img></div>
<div class="imagebox__thumbscontainer">
<div class="imagebox__thumbnail" data-url="https://www.24high.com/images/articles/image.php?id=1548&amp;w=1000&amp;h=1000"> <img alt="" src="../../images/articles/image.php@id=1548&amp;w=200&amp;h=200"/></div> </div>
</div>
</div>
<div class="columns__column columns__column--grow" style="padding-left: 10px;">
<div class="fx fx--ai-center">
<a class="a a--hover-primary fx__i" href="9108146-precision-industrial-scale-12-kg-x-1-gr.html#" onclick="$('#reviewtabbtn').click().get(0).scrollIntoView();
...
<div class="fx__i">Article number: 9108146</div>
</div>
<br/>
<div id="articlePrice">
<span class="text-bold font-2x">€ 469,95</span> (Incl.VAT)            </div>
<br/><br/>
<br>
<div id="articleStockStatus"><i class="fa fa-check success"></i> In stock</div>
<br/>
<select class="input hidden" id="selectVariant" name="variation"><option value="9108146">Precision Industrial Scale 12 Kg X 1 Gr.</option></select>
<div class="fx">
...
<div class="tabs__content" id="tabs_description" style="padding: 10px;">
            This very robust bench scale has a maximum capacity of 12 kilograms and an accuracy of 1 gram. Can be used as a package, count, recipe and check scale. The LCD display can either be mounted on the platform, or be set up separately from the scale with a 1.5 m spiral cable, or can be permanently installed with the included wall holder.Color: silverAccuracy: 1 gramMaximum weighing capacity: 12 kilograms        </div>
