---
title: "Eclipse Duo Truffles | Double Strength Experience"
...
<script>
    ...
    dataLayer.push({
        event: "view_item",
        ecommerce: {"items":[{"quantity":1,"price":20.95,"item_name":"Eclipse Duo Truffels","item_id":"6202868"}],"currency":"EUR","value":20.95}    });
...
<script type="application/ld+json">
    {
        ...
        "@type": "Product",
        "name": "Eclipse Duo Truffles",
        "image": "https://www.24high.com/images/articles/image.php?id=5380&w=300&h=300",
        "description": "Eclipse Duo truffles (Galindoi + Utopia) is a compound truffle blend of two powerful psilocybe species with a distinct and intense character. This combination is mainly chosen by people with extensive experience, who are familiar with strong truffles and are consciously looking for a deep, layered experience without much softening.\nEclipse Duo is a truffle blend of Galindoi and Utopia, developed for experienced users who consciously choose an intense and less forgiving psilocybe experience.\nCurious about what psilocybe truffles are? Read our background information here. Within 24High's range, Eclipse Duo, along with variants like Double Vision and Cosmic Fusion, are among the most distinct choices.\nWhat are Eclipse Duo truffles?\nEclipse Duo consists of a carefully tuned blend of Psilocybe galindoi and Psilocybe utopia. Both species are known for their powerful and distinct character. In this blend, they reinforce each other, resulting in a truffle combination described by many experienced users as intense, layered and immediate. This product is emphatically not intended as an entry-level truffle.\nWhat can you expect from these truffles?\nExperienced users often report that Eclipse Duo can evoke a deep and confrontational experience. The combination of two strong variants creates an experience that can feel both mentally and sensually intense, with little softening. The final experience varies from person to person and is strongly influenced by factors such as dosage, set &amp; setting and previous experience with psilocybe truffles.\nHow to use Eclipse Duo?\nThese truffles are only suitable for experienced users. A conscious and careful approach is essential.\n\nOne pack contains 25 grams, which is often considered one full session\nPreferably use on an empty stomach\nProvide a calm, safe and familiar environment\nDo not combine with alcohol or other substances\n\nWhat is a dose?\nWith strong psilocybe truffles like Eclipse Duo, dosage plays a very important role. What is considered appropriate varies from person to person and depends on experience, sensitivity, body weight and setting, among other things.\nMany experienced users consider 25 grams as a full dose for one intense session. Those who prefer to build up cautiously can start with about 15 grams and, after about 45 minutes, add another 5 to 10 grams if necessary.\nIt is important to note that more is not automatically better. Especially with a powerful blend like Eclipse Duo, a conscious dosage, combined with good preparation and a suitable environment, often contributes more to a valuable experience than quantity alone.\nDosage calculator for magic truffles:\n  \n\nDosageCalculator &gt;&gt;\n\n\nWho is Eclipse Duo suitable for?\nEclipse Duo is especially suitable for people who already have several experiences with strong psilocybe truffles and consciously choose a more intense, less forgiving variety. If you have little or no experience with strong truffles, it is wiser to choose a milder variety from the range.\nIngredients and composition\nThese truffles consist of a mixture of Psilocybe galindoi and Psilocybe utopia. The truffles are freshly packaged and delivered by Royal Magic Truffles.\nPackage contents\nEach pack contains 25 grams of fresh Eclipse Duo truffles.\nSafety &amp; points of attention\nUsing strong truffles requires responsibility and good preparation. Eclipse Duo is mainly intended for experienced users and can be experienced as very intense for beginners or people without experience. Eclipse Duo is not suitable for people with mental vulnerability, minors, pregnant women or during stressful periods. Due to the intensity of this blend, it is extra important to be well informed and respect your own limits. If you are on medication, it is wise to consult your GP before considering psilocybe truffles.\nFrequently asked questions about Eclipse Duo\n\n Is Eclipse Duo suitable for beginners? \u25bc \n\nDue to its pronounced intensity and the combination of two powerful strains, Eclipse Duo is less suitable as a first experience. This blend is mainly intended for users with extensive experience with strong truffles.\n\n\n\n Can I combine Eclipse Duo with other substances? \u25bc \n\nCombining truffles with alcohol or other substances is not recommended, because this can increase the intensity and unpredictability of the experience.\n\n\n\n How do I store Eclipse Duo truffles ? \n\nStore Eclipse Duo refrigerated between 2 and 6 &deg;C in the original, closed packaging. After opening, it is recommended to use the truffles within a few days.\n\n\n\n\nvar acc = document.getElementsByClassName(\"accordion\");\nvar i;\n\nfor (i = 0; i < acc.length; i++) {\n  acc[i].addEventListener(\"click\", function() {\n    this.classList.toggle(\"active\");\n    var panel = this.closest(\"p\").nextElementSibling;\n    var arrow = this.querySelector(\"span\");\n    if (panel.style.display === \"block\") {\n      panel.style.display = \"none\";\n      arrow.style.transform = \"rotate(0deg)\";\n    } else {\n      panel.style.display = \"block\";\n      arrow.style.transform = \"rotate(180deg)\";\n    }\n  });\n}\n\n",
         "brand": {
                "@type": "Brand",
        ...
        "offers": {
            ...
            "url": "https://www.24high.com/en/article/6202868-eclipse-duo-truffles?setlang=en&article=6202868-eclipse-duo-truffles",
            "seller": {
                "@type": "Organization",
                "name": "24High"
            }
        ...
        ,
            ...
            "review": [
                [{"@type":"Review","datePublished":"2026-06-08","description":"These are so far my second favorite truffles to use. The sensations all across the body are heavy and full. The visuals are strong but feel soft. Very enjoyable! I took them with higher than recommended doses too and had a phenomenal experience. As usual though, it is recommended to follow the product description and advice given there before consumption. \r\nA great product!","name":"Wonderful body sensations","author":"Anonymous","reviewRating":{"@type":"Rating","bestRating":"5","ratingValue":5,"worstRating":"1"}}]            ]

            }
</script>
<div class="content">
<h1 class="h1 h1--line" style="color: rgb(101,101,101);">Eclipse Duo Truffles</h1>
...
<img alt="Eclipse Duo Truffles" class="imagebox__mainimage" id="main-product-image" src="../../images/articles/image.php@id=5380&amp;w=1000&amp;h=1000">
<div id="interactive-viewer-container" style="display: none; width: 100%; height: 100%;"></div>
</img></div>
<div class="imagebox__thumbscontainer">
<div class="imagebox__thumbnail" data-url="https://www.24high.com/images/articles/image.php?id=5380&amp;w=1000&amp;h=1000"> <img alt="" src="../../images/articles/image.php@id=5380&amp;w=200&amp;h=200"/></div><div class="imagebox__thumbnail" data-url="https://www.24high.com/images/articles/image.php?id=5381&amp;w=1000&amp;h=1000"> <img alt="" src="../../images/articles/image.php@id=5381&amp;w=200&amp;h=200"/></div> </div>
</div>
</div>
<div class="columns__column columns__column--grow" style="padding-left: 10px;">
<div class="fx fx--ai-center">
<a class="a a--hover-primary fx__i" href="6202868-eclipse-duo-truffles.html#" onclick="$('#reviewtabbtn').click().get(0).scrollIntoView();
...
<div class="fx__i">Article number: 6202868</div>
</div>
<br/>
<div id="articlePrice">
...
<br/>
<select class="input hidden" id="selectVariant" name="variation"><option value="6202868">Eclipse Duo Truffles</option></select>
<div class="fx">
...
<div class="tabs__button" data-tabscontent="#tabs_1854"><i class="far fa-info-circle fa-fw"></i> Disclaimer</div><div class="tabs__button" data-tabscontent="#tabs_1866"><i class="far fa-info-circle fa-fw"></i> Delivery</div> <div class="tabs__button tabs__button--secondary" data-tabscontent="#tabs_reviews" id="reviewtabbtn"><i class="fas fa-star fa-fw"></i> Reviews</div>
</div>
<div class="tabs__content" id="tabs_description" style="padding: 10px;">
<p><strong>Eclipse Duo truffles</strong> (Galindoi + Utopia) is a compound truffle blend of two powerful psilocybe species with a distinct and intense character. This combination is mainly chosen by people with extensive experience, who are familiar with strong truffles and are consciously looking for a deep, layered experience without much softening.</p>
<blockquote>Eclipse Duo is a truffle blend of Galindoi and Utopia, developed for experienced users who consciously choose an intense and less forgiving psilocybe experience.</blockquote>
<p>Curious about what psilocybe truffles are? Read our <span style="text-decoration: underline; color: #1a20e8;"><a href="../blog/176/what-are-psilocybin-truffles.html" style="color: #1a20e8; text-decoration: underline;">background information</a></span> here. Within <span style="text-decoration: underline; color: #1a20e8;"><a href="../mushrooms/16-magic-truffles.html" style="color: #1a20e8; text-decoration: underline;">24High's range</a></span>, Eclipse Duo, along with variants like Double Vision and Cosmic Fusion, are among the most distinct choices.</p>
<h2>What are Eclipse Duo truffles?</h2>
<p>Eclipse Duo consists of a carefully tuned blend of <em>Psilocybe galindoi</em> and <em>Psilocybe utopia</em>. Both species are known for their powerful and distinct character. In this blend, they reinforce each other, resulting in a truffle combination described by many experienced users as intense, layered and immediate. This product is emphatically not intended as an entry-level truffle.</p>
<h2>What can you expect from these truffles?</h2>
<p>Experienced users often report that Eclipse Duo can evoke a deep and confrontational experience. The combination of two strong variants creates an experience that can feel both mentally and sensually intense, with little softening. The final experience varies from person to person and is strongly influenced by factors such as dosage, set &amp; setting and previous experience with psilocybe truffles.</p>
<h2>How to use Eclipse Duo?</h2>
<p>These truffles are only suitable for experienced users. A conscious and careful approach is essential.</p>
<ul>
<li>One pack contains 25 grams, which is often considered one full session</li>
<li>Preferably use on an empty stomach</li>
<li>Provide a calm, safe and familiar environment</li>
<li>Do not combine with alcohol or other substances</li>
</ul>
<h2>What is a dose?</h2>
<p>With strong psilocybe truffles like Eclipse Duo, dosage plays a very important role. What is considered appropriate varies from person to person and depends on experience, sensitivity, body weight and setting, among other things.</p>
<p>Many experienced users consider <strong>25 grams</strong> as a full dose for one intense session. Those who prefer to build up cautiously can start with about 15 grams and, after about 45 minutes, add another 5 to 10 grams if necessary.</p>
<p>It is important to note that more is not automatically better. Especially with a powerful blend like Eclipse Duo, a conscious dosage, combined with good preparation and a suitable environment, often contributes more to a valuable experience than quantity alone.</p>
<p><strong>Dosage calculator for magic truffles:</strong></p>
<div class="container" style="position: relative; font-family: Arial, Helvetica, sans-serif;"><a href="../../magic-mushroom-calculator/index.html"> <img alt="Doseringscalculator voor magische truffels van 24High" src="https://www.24high.nl/files/?id=1562.png&amp;file=Doserings_Banner2.png" style="width: 100%;"/> </a>
...
<h2>Who is Eclipse Duo suitable for?</h2>
<p>Eclipse Duo is especially suitable for people who already have several experiences with strong psilocybe truffles and consciously choose a more intense, less forgiving variety. If you have little or no experience with strong truffles, it is wiser to choose a <span style="text-decoration: underline; color: #1a20e8;"><a href="0209213-psilocybe-jalisco-25-grams.html" style="color: #1a20e8; text-decoration: underline;">milder variety</a></span> from the range.</p>
<h2>Ingredients and composition</h2>
<p>These truffles consist of a mixture of <em>Psilocybe galindoi</em> and <em>Psilocybe utopia</em>. The truffles are freshly packaged and delivered by Royal Magic Truffles.</p>
<h2>Package contents</h2>
<p>Each pack contains 25 grams of fresh Eclipse Duo truffles.</p>
<h2>Safety &amp; points of attention</h2>
<p>Using strong truffles requires responsibility and good preparation. Eclipse Duo is mainly intended for experienced users and can be experienced as very intense for beginners or people without experience. Eclipse Duo is not suitable for people with mental vulnerability, minors, pregnant women or during stressful periods. Due to the intensity of this blend, it is extra important to be well informed and respect your own limits. If you are on medication, it is wise to consult your GP before considering psilocybe truffles.</p>
<h2><span style="color: #34495e;">Frequently asked questions about Eclipse Duo</span></h2>
<div>
<p><button class="accordion" style="background-color: #eee; color: #444; cursor: pointer; padding: 18px; width: 100%; border: none; text-align: left; outline: none; font-size: 15px; transition: 0.4s; position: relative;"> <strong>Is Eclipse Duo suitable for beginners?</strong> <span style="position: absolute; right: 18px; transition: transform 0.4s;">▼</span> </button></p>
<div class="panel" style="padding: 0 18px; display: none; background-color: white; overflow: hidden;">
<p>Due to its pronounced intensity and the combination of two powerful strains, Eclipse Duo is less suitable as a first experience. This blend is mainly intended for users with extensive experience with strong truffles.</p>
</div>
</div>
<div>
<p><button class="accordion" style="background-color: #eee; color: #444; cursor: pointer; padding: 18px; width: 100%; border: none; text-align: left; outline: none; font-size: 15px; transition: 0.4s; position: relative;"> <strong>Can I combine Eclipse Duo with other substances?</strong> <span style="position: absolute; right: 18px; transition: transform 0.4s;">▼</span> </button></p>
<div class="panel" style="padding: 0 18px; display: none; background-color: white; overflow: hidden;">
<p>Combining truffles with alcohol or other substances is not recommended, because this can increase the intensity and unpredictability of the experience.</p>
</div>
</div>
<div>
<p><button class="accordion" style="background-color: #eee; color: #444; cursor: pointer; padding: 18px; width: 100%; border: none; text-align: left; outline: none; font-size: 15px; transition: 0.4s; position: relative;"> <strong>How do I store Eclipse Duo truffles</strong> <span style="position: absolute; right: 18px; transition: transform 0.4s;">?</span> </button></p>
<div class="panel" style="padding: 0 18px; display: none; background-color: white; overflow: hidden;">
<p>Store Eclipse Duo refrigerated between 2 and 6 °C in the original, closed packaging. After opening, it is recommended to use the truffles within a few days.</p>
</div>
</div>
<p>
<script>
...
<div class="tabs__content" id="tabs_1854" style="padding: 10px;"><p>The information on this page is for general information purposes only and does not constitute medical or therapeutic advice. The effects of psilocybe truffles vary from person to person and situation to situation. This product is not suitable for minors, pregnant women or persons with mental vulnerability. Do not combine with alcohol, drugs or other substances. Do not participate in traffic under the influence. Always consult a doctor if in doubt about health, mental state or medication use. Use is entirely at your own responsibility. Check local laws and regulations.</p></div><div class="tabs__content" id="tabs_1866" style="padding: 10px;"><p>This product is intended for lawful use. By purchasing, you confirm that you are of legal age and are familiar with the laws in force in your country.</p>
