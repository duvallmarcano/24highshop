---
title: "Pandora`s Magic Truffle Growkit - 24High"
...
<script>
    ...
    dataLayer.push({
        event: "view_item",
        ecommerce: {"items":[{"quantity":1,"price":22.5,"item_name":"Pandora`s Magic Truffel Growkit - Atlantis","item_id":"2205884"}],"currency":"EUR","value":22.5}    });
...
<script type="application/ld+json">
    {
        ...
        "@type": "Product",
        "name": "Pandora`s Magic Truffle Growkit",
        "image": "https://www.24high.com/images/articles/image.php?id=5385&w=300&h=300",
        "description": "The Pandora`s Magic Truffle Growkit is developed for people who consciously choose a fresh and high-quality truffle experience. You receive a ready-to-use growkit with fresh magic truffles that are harvestable immediately upon arrival. You can also choose to let the kit continue growing for a while to achieve a higher yield.\nPandora&rsquo;s Magic Truffle Growkit is a ready-to-use cultivation kit that allows you to harvest fresh magic truffles. Available in four separate variants, each with its own character and intensity.\nThe Pandora Magic Truffle Growkit is available in four variants. You therefore choose one specific variant that matches your preference and experience level.\nWhat is Pandora&rsquo;s Magic Truffle Growkit?\nThe Pandora&rsquo;s Magic Truffle Growkit is a ready-to-use cultivation kit containing fresh magic truffles (sclerotia). This product line consists of four individual variants:\n\nAtlantis &ndash; balanced and creative character\nMexicana &ndash; mild and accessible\nUtopia &ndash; deep and introspective\nTampanensis &ndash; philosophical and insightful\n\nSclerotia are compact underground structures in which psilocybin naturally occurs.\nThe growkit is prepared so that the truffles are ready for use upon delivery. You do not need to follow complicated cultivation steps. Would you like a higher yield? You can allow the growkit to continue growing for up to one month at room temperature while keeping the container closed.\nAlso explore the main collection: growkits and learn more background information in our guide: the ultimate magic truffle guide.\nEffects and experience\nThe experience depends on the selected variant, dosage, and personal mindset. Many users report:\n\nEnhanced visual perception\nMore intense music appreciation\nCreative or reflective thoughts\nEuphoric moments\n\nThe effects usually begin after 30 to 45 minutes and often last between 6 and 8 hours. The intensity depends on the amount consumed, your body weight, and your mindset.\nDosage and guidelines\nAlways start carefully, especially if you are not yet familiar with this variant.\n\nLight experience&plusmn; 0.1 gram per kg body weight\nMild experience&plusmn; 0.13 &ndash; 0.15 gram per kg\nIntense experience&plusmn; 0.22 gram per kg\n\nPreferably use on an empty stomach and always in a calm, safe environment. Make sure a sober person is present who can support you during the experience.\nRead more practical tips here: set &amp; setting for truffles.\nHow to use the growkit\nHarvesting\n\nRemove the truffles from the container\nRinse them gently (optionally using a soft brush)\nPat them dry with a clean cloth\n\nYou can consume them immediately or store them refrigerated for a short period.\nAllowing the kit to grow longer for higher yield\n\nKeep the lid closed\nPlace the kit at room temperature\nAvoid direct sunlight\nAllow to grow for a maximum of 1 month\n\nExpected yield: 40 to 70 grams depending on conditions.\nWho is this growkit suitable for?\nThe Pandora Magic Truffle Growkit is often chosen by people who:\n\nwant to select a specific truffle variant that suits their preference\nare interested in visual or creative effects\ntake time for introspection\nwant to experience music or nature more intensely\n\nNot sure which variant suits you best? Also explore our truffle category.\nSafety and precautions\nDo not use this product:\n\nin combination with alcohol\nin combination with MAO inhibitors or certain medications\nduring pregnancy or breastfeeding\nin case of psychological instability\n\nDo not participate in traffic after use.\nContents of the Pandora Magic Truffle Growkit\n\n1 growkit with fresh magic truffles\n1 selected variant: Atlantis, Mexicana, Utopia or Tampanensis\nExpected yield: 40 &ndash; 70 grams\n\nFrequently Asked Questions about Pandora&rsquo;s Magic Truffel Growkit\n\n Is Pandora suitable for beginners? \u25bc \n\nPandora is usually chosen by experienced users because of its powerful character. For a first experience, a milder variant is often more suitable.\n\n\n Can I use the growkit multiple times? \u25bc \n\nThis growkit is intended for one harvest cycle. You can increase the yield by allowing the kit to continue growing for up to one month before harvesting.\n\n\n\n How should I store fresh truffles after harvesting? \u25bc \n\nStore fresh truffles in an airtight container in the refrigerator. For best quality and effect, it is recommended to use them as fresh as possible.\n\n\n\n\n\nvar acc = document.getElementsByClassName(\"accordion\");\nvar i;\n\nfor (i = 0; i < acc.length; i++) {\n  acc[i].addEventListener(\"click\", function() {\n    this.classList.toggle(\"active\");\n    var panel = this.closest(\"p\").nextElementSibling;\n    var arrow = this.querySelector(\"span\");\n    if (panel.style.display === \"block\") {\n      panel.style.display = \"none\";\n      arrow.style.transform = \"rotate(0deg)\";\n    } else {\n      panel.style.display = \"block\";\n      arrow.style.transform = \"rotate(180deg)\";\n    }\n  });\n}\n\n",
         "sku": "2205884",
        "gtin13": "",
        "mpn": "",
        "offers": {
            ...
            "url": "https://www.24high.com/en/article/2205884-pandoras-magic-truffles-growkit?setlang=en&article=2205884-pandoras-magic-truffles-growkit",
            "seller": {
                "@type": "Organization",
                "name": "24High"
            }
...
<div class="content">
<h1 class="h1 h1--line" style="color: rgb(101,101,101);">Pandora`s Magic Truffle Growkit</h1>
...
<img alt="Pandora`s Magic Truffle Growkit" class="imagebox__mainimage" id="main-product-image" src="../../images/articles/image.php@id=5385&amp;w=1000&amp;h=1000">
<div id="interactive-viewer-container" style="display: none; width: 100%; height: 100%;"></div>
</img></div>
<div class="imagebox__thumbscontainer">
<div class="imagebox__thumbnail" data-url="https://www.24high.com/images/articles/image.php?id=5385&amp;w=1000&amp;h=1000"> <img alt="" src="../../images/articles/image.php@id=5385&amp;w=200&amp;h=200"/></div><div class="imagebox__thumbnail" data-url="https://www.24high.com/images/articles/image.php?id=3630&amp;w=1000&amp;h=1000"> <img alt="" src="../../images/articles/image.php@id=3630&amp;w=200&amp;h=200"/></div> </div>
</div>
</div>
<div class="columns__column columns__column--grow" style="padding-left: 10px;">
<div class="fx fx--ai-center">
<a class="a a--hover-primary fx__i" href="2205884-pandoras-magic-truffles-growkit.html#" onclick="$('#reviewtabbtn').click().get(0).scrollIntoView();
...
<div class="fx__i">Article number: 2205884</div>
</div>
<br/>
<div id="articlePrice">
<span class="text-bold font-2x">€ 22,50</span> (Incl.VAT)            </div>
<br/><br/>
<div class="ftable ftable--on-white ftable--secondary"><div class="ftable__row"><div class="ftable__cell">Buy 2 items</div><div class="ftable__cell">For € 21,50 Each</div></div><div class="ftable__row"><div class="ftable__cell">Buy 3 items</div><div class="ftable__cell">For € 20,50 Each</div></div><div class="ftable__row"><div class="ftable__cell">Buy 4 items</div><div class="ftable__cell">For € 19,50 Each</div></div><div class="ftable__row"><div class="ftable__cell">Buy 5 items</div><div class="ftable__cell">For € 18,50 Each</div></div></div>
<br>
<div id="articleStockStatus"><i class="fa fa-check success"></i> In stock</div>
<br/>
<div class="fx__i"><select class="input input--w100" id="selectVariant" name="variation"><option value="2205884">Pandora`s Magic Truffles Growkit </option><option value="6203488">Pandora`s Magic Truffle Growkit - Mexicana</option><option value="6203778">Pandora`s Magic Truffle Growkit - Utopia</option><option value="6203357">Pandora`s Magic Truffle Growkit - Tampanensis</option></select></div>
<div class="fx">
...
<div class="tabs__button" data-tabscontent="#tabs_1759"><i class="far fa-info-circle fa-fw"></i> Disclaimer</div> <div class="tabs__button tabs__button--secondary" data-tabscontent="#tabs_reviews" id="reviewtabbtn"><i class="fas fa-star fa-fw"></i> Reviews</div>
</div>
...
<p>Also explore the main collection: <span style="text-decoration: underline; color: #1a20e8;"><a href="../mushrooms/24-growkits-mushroom.html" style="color: #1a20e8; text-decoration: underline;">growkits</a></span> and learn more background information in our guide: <span style="text-decoration: underline; color: #1a20e8;"><a href="../blog/9/the-ultimate-magic-truffels-guide.html" style="color: #1a20e8; text-decoration: underline;">the ultimate magic truffle guide</a></span>.</p>
...
<div style="flex: 1; min-width: 220px; padding: 20px; border-radius: 12px; background: #f5f7ff;"><strong>Light experience</strong><br/>± 0.1 gram per kg body weight</div>
<div style="flex: 1; min-width: 220px; padding: 20px; border-radius: 12px; background: #f5fff7;"><strong>Mild experience</strong><br/>± 0.13 – 0.15 gram per kg</div>
<div style="flex: 1; min-width: 220px; padding: 20px; border-radius: 12px; background: #fff5f5;"><strong>Intense experience</strong><br/>± 0.22 gram per kg</div>
</div>
...
<p>Read more practical tips here: <span style="text-decoration: underline; color: #1a20e8;"><a href="../blog/438/what-are-set-and-setting-and-why-are-they-so-important-when-tripping.html" style="color: #1a20e8; text-decoration: underline;">set &amp; setting for truffles</a></span>.</p>
...
<p>Not sure which variant suits you best? Also explore our <span style="text-decoration: underline; color: #1a20e8;"><a href="../mushrooms/16-magic-truffles.html" style="color: #1a20e8; text-decoration: underline;">truffle category</a></span>.</p>
...
<h2><span style="color: #34495e;">Frequently Asked Questions about Pandora’s Magic Truffel Growkit</span></h2>
<div itemprop="mainEntity" itemscope="" itemtype="https://schema.org/Question">
<p><button class="accordion" style="background-color: #eee; color: #444; cursor: pointer; padding: 18px; width: 100%; border: none; text-align: left; outline: none; font-size: 15px; transition: 0.4s; position: relative;"> <strong itemprop="name">Is Pandora suitable for beginners?</strong> <span style="position: absolute; right: 18px; transition: transform 0.4s;">▼</span> </button></p>
...
<p itemprop="text">Pandora is usually chosen by experienced users because of its powerful character. For a first experience, a milder variant is often more suitable.</p>
</div>
<div itemprop="mainEntity" itemscope="" itemtype="https://schema.org/Question">
<p><button class="accordion" style="background-color: #eee; color: #444; cursor: pointer; padding: 18px; width: 100%; border: none; text-align: left; outline: none; font-size: 15px; transition: 0.4s; position: relative;"> <strong itemprop="name">Can I use the growkit multiple times?</strong> <span style="position: absolute; right: 18px; transition: transform 0.4s;">▼</span> </button></p>
<div class="panel" itemprop="acceptedAnswer" itemscope="" itemtype="https://schema.org/Answer" style="padding: 0 18px; display: none; background-color: white; overflow: hidden;">
<p itemprop="text">This growkit is intended for one harvest cycle. You can increase the yield by allowing the kit to continue growing for up to one month before harvesting.</p>
</div>
</div>
<div itemprop="mainEntity" itemscope="" itemtype="https://schema.org/Question">
<p><button class="accordion" style="background-color: #eee; color: #444; cursor: pointer; padding: 18px; width: 100%; border: none; text-align: left; outline: none; font-size: 15px; transition: 0.4s; position: relative;"> <strong itemprop="name">How should I store fresh truffles after harvesting?</strong> <span style="position: absolute; right: 18px; transition: transform 0.4s;">▼</span> </button></p>
<div class="panel" itemprop="acceptedAnswer" itemscope="" itemtype="https://schema.org/Answer" style="padding: 0 18px; display: none; background-color: white; overflow: hidden;">
<p itemprop="text">Store fresh truffles in an airtight container in the refrigerator. For best quality and effect, it is recommended to use them as fresh as possible.</p>
</div>
</div>
</div>
<p>
...
<div class="tabs__content" id="tabs_1759" style="padding: 10px;"><h3>Disclaimer:</h3>
...
<div class="article__actions"><a aria-label="Product Trip-stopper " class="article__button btn btn--secondary btn--block dialog-dismiss" href="7112720-trip-stopper.html"><svg aria-hidden="true" class="svg-inline--fa fa-info-circle fa-fw" data-fa-i2svg="" data-icon="info-circle" data-prefix="fas" focusable="false" role="img" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" fill="currentColor"></path></svg></a><a aria-label="Order Trip-stopper " class="article__button btn btn--primary btn--block addArticleToCart dialog-dismiss" data-articlenumber="7112720" href="2205884-pandoras-magic-truffles-growkit.html#"><svg aria-hidden="true" class="svg-inline--fa fa-cart-plus fa-fw" data-fa-i2svg="" data-icon="cart-plus" data-prefix="fas" focusable="false" role="img" viewbox="0 0 576 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 24C0 10.7 10.7 0 24 0H69.5c22 0 41.5 12.8 50.6 32h411c26.3 0 45.5 25 38.6 50.4l-41 152.3c-8.5 31.4-37 53.3-69.5 53.3H170.7l5.4 28.5c2.2 11.3 12.1 19.5 23.6 19.5H488c13.3 0 24 10.7 24 24s-10.7 24-24 24H199.7c-34.6 0-64.3-24.6-70.7-58.5L77.4 54.5c-.7-3.8-4-6.5-7.9-6.5H24C10.7 48 0 37.3 0 24zM128 464a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm336-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96zM252 160c0 11 9 20 20 20h44v44c0 11 9 20 20 20s20-9 20-20V180h44c11 0 20-9 20-20s-9-20-20-20H356V96c0-11-9-20-20-20s-20 9-20 20v44H272c-11 0-20 9-20 20z" fill="currentColor"></path></svg></a></div>
</div>
</div></div> </div>
</div>
<div class="clear"></div>
