---
title: "McMicrodose - 2 x 5 grams - 24High"
...
<script>
    ...
    dataLayer.push({
        event: "view_item",
        ecommerce: {"items":[{"quantity":1,"price":9.95,"item_name":"McMicrodose \u2013 2 x 5 gram","item_id":"2209618"}],"currency":"EUR","value":9.95}    });
...
<script type="application/ld+json">
    {
        ...
        "@type": "Product",
        "name": "McMicrodose - 2 x 5 grams",
        "image": "https://www.24high.com/images/articles/image.php?id=3663&w=300&h=300",
        "description": "McMicrodose &ndash; 2 x 5 grams contains a carefully composed mix of psilocybin truffles that have been specially selected for microdosing. The truffles are chosen for their balanced character and subtle effects, making them suitable for people who want to explore microdosing in a calm and controlled way.\nMicrodosing with truffles means using a very small amount of psilocybin. This means you will not experience a full psychedelic trip, but subtle changes in focus, creativity, or mood may be noticeable.\nWant to learn more about microdosing? Read our guide microdosing for beginners or explore all products in the category microdosing truffles.\nWhat is McMicrodose?\nMcMicrodose is a microdosing product with natural psilocybin truffles. The product is designed for people who want to try microdosing and are looking for a practical way to use small amounts of truffles.\nWhen microdosing, a very small amount of truffles is used. The dose is significantly lower than during a full psychedelic experience. Because of this, the effects usually remain subtle and daily activities can generally continue as normal.\nContents of McMicrodose\n\n2 &times; 5 grams premium psilocybin truffles\n\nThe portions are designed so that you can easily take multiple microdoses from a single package.\nHow do you start microdosing?\nWhen starting with microdosing, it is recommended to begin slowly and observe how your body responds.\n1. Start with a low dose\nMany people begin with approximately 0.5 to 1.5 grams of fresh truffles.\nWant an indication of the right amount? Use our calculator:\nMicrodosing dosage calculator\n  \n\nDosageCalculator &gt;&gt;\n\n\n\nOpen one sachet of McMicrodose and place the contents in the tray. The other sachet can be stored in the refrigerator for later use.\n2. Commonly used microdosing schedule\nA commonly used microdosing schedule is to take a small dose on one day and then take two days off. This allows the body time to process the effects and usually helps prevent tolerance from building up too quickly.\n\nDay 1: take a microdose\nDay 2: no dose\nDay 3: no dose\nDay 4: take a microdose again\n\nThese pause days help you better observe how the microdose works for you.\n3. Tips for use\n\nTruffles often work best on an empty stomach.\nChew the truffles thoroughly before swallowing.\nRest, meditation, or a calm environment can contribute to a positive experience.\nMany people prefer to microdose during a period without alcohol.\n\nHow do you store McMicrodose truffles?\n\nStore the truffles in a dark place.\nThe ideal storage temperature is between 2&deg;C and 4&deg;C (in the refrigerator).\nClose the packaging properly to maintain freshness.\n\nSafety &amp; considerations\n\nNot suitable for persons under 18 years of age.\nDo not use during pregnancy or breastfeeding.\nDo not combine with alcohol, medication, or other psychoactive substances.\nAvoid use if you have serious physical or psychological conditions.\n\nAlways start with a low dose and only increase it carefully if necessary.\nFrequently Asked Questions (FAQ)\n\nWhat is a microdose of truffles?\u25bc\n\nA microdose is a very small amount of psilocybin truffles. The dose is so low that a full psychedelic experience usually does not occur, but some users experience subtle changes in focus or creativity.\n\nHow many truffles should you use for microdosing?\u25bc\n\nMany people start with about 0.5 to 1.5 grams of fresh truffles. The ideal dose may vary from person to person.\n\nHow often can you take a microdose?\u25bc\n\nA commonly used schedule is dosing on one day followed by two days of rest. This helps limit tolerance.\n\nHow long do McMicrodose truffles stay fresh?\u25bc\n\nIf you store the truffles in the refrigerator between 2 and 4 &deg;C and close the packaging properly, they usually stay fresh until the expiration date on the package.\n\n\n\n\nvar acc=document.getElementsByClassName(\"accordion\");\nvar i;\nfor(i=0;i",
         "sku": "2209618",
        "gtin13": "",
        "mpn": "2014800",
        "offers": {
            ...
            "url": "https://www.24high.com/en/article/2209618-mcmicrodose-2-x-5-grams?setlang=en&article=2209618-mcmicrodose-2-x-5-grams",
            "seller": {
                "@type": "Organization",
                "name": "24High"
            }
...
<div class="content">
<h1 class="h1 h1--line" style="color: rgb(101,101,101);">McMicrodose - 2 x 5 grams</h1>
...
<img alt="McMicrodose - 2 x 5 grams" class="imagebox__mainimage" id="main-product-image" src="../../images/articles/image.php@id=3663&amp;w=1000&amp;h=1000">
<div id="interactive-viewer-container" style="display: none; width: 100%; height: 100%;"></div>
</img></div>
<div class="imagebox__thumbscontainer">
<div class="imagebox__thumbnail" data-url="https://www.24high.com/images/articles/image.php?id=3663&amp;w=1000&amp;h=1000"> <img alt="" src="../../images/articles/image.php@id=3663&amp;w=200&amp;h=200"/></div><div class="imagebox__thumbnail" data-url="https://www.24high.com/images/articles/image.php?id=3664&amp;w=1000&amp;h=1000"> <img alt="" src="../../images/articles/image.php@id=3664&amp;w=200&amp;h=200"/></div> </div>
</div>
</div>
<div class="columns__column columns__column--grow" style="padding-left: 10px;">
<div class="fx fx--ai-center">
<a class="a a--hover-primary fx__i" href="2209618-mcmicrodose-2-x-5-grams.html#" onclick="$('#reviewtabbtn').click().get(0).scrollIntoView();
...
<div class="fx__i">Article number: 2209618</div>
</div>
<br/>
<div id="articlePrice">
...
<br/>
<select class="input hidden" id="selectVariant" name="variation"><option value="2209618">McMicrodose - 2 x 5 grams</option></select>
<div class="fx">
...
<div class="tabs__button" data-tabscontent="#tabs_1772"><i class="far fa-info-circle fa-fw"></i> Disclaimer</div> <div class="tabs__button tabs__button--secondary" data-tabscontent="#tabs_reviews" id="reviewtabbtn"><i class="fas fa-star fa-fw"></i> Reviews</div>
</div>
<div class="tabs__content" id="tabs_description" style="padding: 10px;">
<p><strong>McMicrodose <span>– 2 x 5 grams</span></strong> contains a carefully composed mix of psilocybin truffles that have been specially selected for microdosing. The truffles are chosen for their balanced character and subtle effects, making them suitable for people who want to explore microdosing in a calm and controlled way.</p>
...
<p>Want to learn more about microdosing? Read our guide <span style="text-decoration: underline; color: #1a20e8;"><a href="../blog/477/microdosing-for-beginners-how-to-start-responsibly-with-an-emerging-trend.html" style="color: #1a20e8; text-decoration: underline;">microdosing for beginners</a></span> or explore all products in the category <span style="text-decoration: underline; color: #1a20e8;"><a href="../mushrooms/189-microdosing.html" style="color: #1a20e8; text-decoration: underline;">microdosing truffles</a></span>.</p>
...
<p><button class="accordion" style="background-color: #eee; color: #444; cursor: pointer; padding: 18px; width: 100%; border: none; text-align: left; outline: none; font-size: 15px; transition: 0.4s; position: relative;"><strong>How long do McMicrodose truffles stay fresh?</strong><span style="position: absolute; right: 18px; transition: transform 0.4s;">▼</span></button></p>
<div class="panel" style="display: none;">
...
<div class="tabs__content" id="tabs_1772" style="padding: 10px;"><h3>Disclaimer:</h3>
