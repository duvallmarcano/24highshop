---
title: "Psilocybe Mexicana Truffles - 24High"
...
<script>
    ...
    dataLayer.push({
        event: "view_item",
        ecommerce: {"items":[{"quantity":1,"price":13.95,"item_name":"Psilocybe Mexicana Truffels","item_id":"4203784"}],"currency":"EUR","value":13.95}    });
...
<script type="application/ld+json">
    {
        ...
        "@type": "Product",
        "name": "Psilocybe Mexicana Truffles",
        "image": "https://www.24high.com/images/articles/image.php?id=4212&w=300&h=300",
        "description": "Psilocybe Mexicana truffles are among the milder options in the 24High assortment. This variety is known for its approachable character and is often chosen by beginners or by users looking for a lighter, more manageable psilocybin experience. Mexicana offers subtle visual effects and gentle changes in perception without the intensity of stronger varieties.\nPsilocybe Mexicana is a mild to medium-strength psilocybin truffle that is often chosen as a first introduction to magic truffles.\nWant to compare different varieties? Explore our full category of magic truffles or read more about the background and effects of psilocybin truffles.\nWhat are Psilocybe Mexicana truffles?\nMexicana truffles are sclerotia from the Psilocybe family. Sclerotia are underground nutrient reserves of the mushroom. They naturally contain psilocybin, which is converted into psilocin in the body after ingestion.\nPsilocin affects serotonin receptors and is associated with changes in perception, mood, and thought patterns. How this is experienced differs per person and depends on dosage, mindset (set), and environment (setting).\nWhat can you expect from Mexicana?\nMexicana is generally experienced as mild to medium in strength. Many users describe the effects as manageable and gradually building.\n\nSlightly enhanced sensory perception\nSubtle visual effects\nChanged sense of time\nUplifted or energetic mood\nReflective or creative thoughts\n\nEffects typically start within 30 to 60 minutes and last around 4 to 6 hours on average. Intensity varies from person to person.\nHow do you use Psilocybe Mexicana?\nMexicana is suitable for users who approach psilocybin consciously and carefully. A calm environment and attention to set &amp; setting contribute to a positive experience.\n\nOne pack contains 15 grams of fresh truffles\nPreferably use on an empty stomach\nChew the truffles well for optimal absorption\nDo not combine with alcohol or other substances\n\nWhat is a dose?\nEven with milder truffles like Mexicana, dosage plays an important role. What feels appropriate differs per person and depends on experience, sensitivity, and setting.\nMany users consider 15 grams a full session. If you want to start carefully, you can begin with about 7 to 10 grams to experience the effects more gradually.\nTaking more does not automatically lead to a better experience. A mindful dosage and good preparation generally contribute more to a positive session than quantity alone.\nTrip dosage calculator magic truffles:\n  \n\nDosageCalculator &gt;&gt;\n\n\nWho are Mexicana truffles suitable for?\nMexicana is especially suitable for beginners or users looking for a milder psilocybin experience. If you are looking for a more intense or more strongly visual variety, a stronger variety within the assortment may be a better match.\nIngredients and composition\nThese truffles consist of fresh sclerotia of the Psilocybe Mexicana variety. The truffles are packed fresh and supplied by Royal Magic Truffles.\nPackage contents\nEach pack contains 15 grams of fresh Psilocybe Mexicana truffles.\nSafety &amp; considerations\nUsing psilocybin truffles requires responsibility and preparation. Mexicana is less intense than stronger varieties, but can still feel powerful. Not suitable for minors, people with psychological vulnerability, during pregnancy, or when using certain medication. If in doubt, always consult a doctor.\nFrequently asked questions about Mexicana\n\n Is Mexicana suitable for beginners? \u25bc \n\nYes. Mexicana is often chosen as a first introduction due to its milder character and more manageable intensity.\n\n\n\n How long do the effects last? \u25bc \n\nEffects typically start within 30 to 60 minutes and last around 4 to 6 hours on average, depending on dosage and personal sensitivity.\n\n\n\n How do I store Mexicana truffles? \u25bc \n\nStore Mexicana refrigerated between 2 and 4 &deg;C in the original packaging. Preferably use within a few days after opening.\n\n\n\n\nvar acc = document.getElementsByClassName(\"accordion\");\nvar i;\n\nfor (i = 0; i < acc.length; i++) {\n  acc[i].addEventListener(\"click\", function() {\n    this.classList.toggle(\"active\");\n    var panel = this.closest(\"p\").nextElementSibling;\n    var arrow = this.querySelector(\"span\");\n    if (panel.style.display === \"block\") {\n      panel.style.display = \"none\";\n      arrow.style.transform = \"rotate(0deg)\";\n    } else {\n      panel.style.display = \"block\";\n      arrow.style.transform = \"rotate(180deg)\";\n    }\n  });\n}\n\n\n",
         "brand": {
                "@type": "Brand",
                "name": "Royal magic truffles"
            },
         "sku": "4203784",
        "gtin13": "",
        "mpn": "",
        "offers": {
            ...
            "url": "https://www.24high.com/en/article/4203784-psilocybe-mexicana-truffles?setlang=en&article=4203784-psilocybe-mexicana-truffles",
            "seller": {
                "@type": "Organization",
                "name": "24High"
            }
...
<div class="content">
<h1 class="h1 h1--line" style="color: rgb(101,101,101);">Psilocybe Mexicana Truffles</h1>
...
<img alt="Psilocybe Mexicana Truffles" class="imagebox__mainimage" id="main-product-image" src="../../images/articles/image.php@id=4212&amp;w=1000&amp;h=1000">
<div id="interactive-viewer-container" style="display: none; width: 100%; height: 100%;"></div>
</img></div>
<div class="imagebox__thumbscontainer">
<div class="imagebox__thumbnail" data-url="https://www.24high.com/images/articles/image.php?id=4212&amp;w=1000&amp;h=1000"> <img alt="" src="../../images/articles/image.php@id=4212&amp;w=200&amp;h=200"/></div> </div>
</div>
</div>
<div class="columns__column columns__column--grow" style="padding-left: 10px;">
<div class="fx fx--ai-center">
<a class="a a--hover-primary fx__i" href="4203784-psilocybe-mexicana-truffles.html#" onclick="$('#reviewtabbtn').click().get(0).scrollIntoView();
...
<div class="fx__i">Article number: 4203784</div>
</div>
<br/>
<div id="articlePrice">
...
<br/>
<select class="input hidden" id="selectVariant" name="variation"><option value="4203784">Psilocybe Mexicana Truffles</option></select>
<div class="fx">
...
<div class="tabs__button" data-tabscontent="#tabs_1763"><i class="far fa-info-circle fa-fw"></i> Disclaimer</div><div class="tabs__button" data-tabscontent="#tabs_1807"><i class="far fa-info-circle fa-fw"></i> Delivery</div> <div class="tabs__button tabs__button--secondary" data-tabscontent="#tabs_reviews" id="reviewtabbtn"><i class="fas fa-star fa-fw"></i> Reviews</div>
</div>
<div class="tabs__content" id="tabs_description" style="padding: 10px;">
<p><strong>Psilocybe Mexicana truffles</strong> are among the milder options in the 24High assortment. This variety is known for its approachable character and is often chosen by beginners or by users looking for a lighter, more manageable psilocybin experience. Mexicana offers subtle visual effects and gentle changes in perception without the intensity of stronger varieties.</p>
<blockquote>Psilocybe Mexicana is a mild to medium-strength psilocybin truffle that is often chosen as a first introduction to magic truffles.</blockquote>
<p>Want to compare different varieties? Explore our full category of <span style="text-decoration: underline; color: #1a20e8;"><a href="../mushrooms/16-magic-truffles.html" style="color: #1a20e8; text-decoration: underline;">magic truffles</a></span> or read more about the background and effects of <span style="text-decoration: underline; color: #1a20e8;"><a href="../blog/176/what-are-psilocybin-truffles.html" style="color: #1a20e8; text-decoration: underline;">psilocybin truffles</a></span>.</p>
<h2>What are Psilocybe Mexicana truffles?</h2>
<p>Mexicana truffles are sclerotia from the Psilocybe family. Sclerotia are underground nutrient reserves of the mushroom. They naturally contain psilocybin, which is converted into psilocin in the body after ingestion.</p>
<p>Psilocin affects serotonin receptors and is associated with changes in perception, mood, and thought patterns. How this is experienced differs per person and depends on dosage, mindset (set), and environment (setting).</p>
<h2>What can you expect from Mexicana?</h2>
<p>Mexicana is generally experienced as mild to medium in strength. Many users describe the effects as manageable and gradually building.</p>
<ul>
<li>Slightly enhanced sensory perception</li>
<li>Subtle visual effects</li>
<li>Changed sense of time</li>
<li>Uplifted or energetic mood</li>
<li>Reflective or creative thoughts</li>
</ul>
<p>Effects typically start within 30 to 60 minutes and last around 4 to 6 hours on average. Intensity varies from person to person.</p>
<h2>How do you use Psilocybe Mexicana?</h2>
<p>Mexicana is suitable for users who approach psilocybin consciously and carefully. A calm environment and attention to set &amp; setting contribute to a positive experience.</p>
<ul>
<li>One pack contains 15 grams of fresh truffles</li>
<li>Preferably use on an empty stomach</li>
<li>Chew the truffles well for optimal absorption</li>
<li>Do not combine with alcohol or other substances</li>
</ul>
<h2>What is a dose?</h2>
<p>Even with milder truffles like Mexicana, dosage plays an important role. What feels appropriate differs per person and depends on experience, sensitivity, and setting.</p>
<p>Many users consider <strong>15 grams</strong> a full session. If you want to start carefully, you can begin with about 7 to 10 grams to experience the effects more gradually.</p>
<p>Taking more does not automatically lead to a better experience. A mindful dosage and good preparation generally contribute more to a positive session than quantity alone.</p>
<div><strong>Trip dosage calculator magic truffles:<br/><br/></strong>
<div class="container" style="position: relative; font-family: Arial, Helvetica, sans-serif;"><a href="../../magic-mushroom-calculator/index.html" title="doage calculator"> <img alt="Dosage calculator for magic truffles" src="https://www.24high.nl/files/?id=1562.png&amp;file=Doserings_Banner2.png" style="width: 100%;"/> </a>
...
<p>Mexicana is especially suitable for beginners or users looking for a milder psilocybin experience. If you are looking for a more intense or more strongly visual variety, a <span style="text-decoration: underline; color: #1a20e8;"><a href="0201630-psilocybe-utopia-truffels-15-gram.html" style="color: #1a20e8; text-decoration: underline;">stronger variety</a></span> within the assortment may be a better match.</p>
<h2>Ingredients and composition</h2>
<p>These truffles consist of fresh sclerotia of the <em>Psilocybe Mexicana</em> variety. The truffles are packed fresh and supplied by Royal Magic Truffles.</p>
<h2>Package contents</h2>
<p>Each pack contains 15 grams of fresh Psilocybe Mexicana truffles.</p>
<h2>Safety &amp; considerations</h2>
<p>Using psilocybin truffles requires responsibility and preparation. Mexicana is less intense than stronger varieties, but can still feel powerful. Not suitable for minors, people with psychological vulnerability, during pregnancy, or when using certain medication. If in doubt, always consult a doctor.</p>
<h2><span style="color: #34495e;">Frequently asked questions about Mexicana</span></h2>
<div>
<p><button class="accordion" style="background-color: #eee; color: #444; cursor: pointer; padding: 18px; width: 100%; border: none; text-align: left; outline: none; font-size: 15px; position: relative;"> <strong>Is Mexicana suitable for beginners?</strong> <span style="position: absolute; right: 18px;">▼</span> </button></p>
<div class="panel" style="padding: 0 18px; display: none; background-color: white; overflow: hidden;">
<p>Yes. Mexicana is often chosen as a first introduction due to its milder character and more manageable intensity.</p>
</div>
</div>
<div>
...
<div class="panel" style="padding: 0 18px; display: none; background-color: white; overflow: hidden;">
<p>Effects typically start within 30 to 60 minutes and last around 4 to 6 hours on average, depending on dosage and personal sensitivity.</p>
</div>
</div>
<div>
<p><button class="accordion" style="background-color: #eee; color: #444; cursor: pointer; padding: 18px; width: 100%; border: none; text-align: left; outline: none; font-size: 15px; position: relative;"> <strong>How do I store Mexicana truffles?</strong> <span style="position: absolute; right: 18px;">▼</span> </button></p>
<div class="panel" style="padding: 0 18px; display: none; background-color: white; overflow: hidden;">
<p>Store Mexicana refrigerated between 2 and 4 °C in the original packaging. Preferably use within a few days after opening.</p>
</div>
</div>
<p>
<script>
...
<div class="article__actions"><a aria-label="Product Recycold Cool Pack" class="article__button btn btn--secondary btn--block dialog-dismiss" href="5205818-recycold-cool-pack.html"><svg aria-hidden="true" class="svg-inline--fa fa-info-circle fa-fw" data-fa-i2svg="" data-icon="info-circle" data-prefix="fas" focusable="false" role="img" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" fill="currentColor"></path></svg></a><a aria-label="Order Recycold Cool Pack" class="article__button btn btn--primary btn--block addArticleToCart dialog-dismiss" data-articlenumber="5205818" href="4203784-psilocybe-mexicana-truffles.html#"><svg aria-hidden="true" class="svg-inline--fa fa-cart-plus fa-fw" data-fa-i2svg="" data-icon="cart-plus" data-prefix="fas" focusable="false" role="img" viewbox="0 0 576 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 24C0 10.7 10.7 0 24 0H69.5c22 0 41.5 12.8 50.6 32h411c26.3 0 45.5 25 38.6 50.4l-41 152.3c-8.5 31.4-37 53.3-69.5 53.3H170.7l5.4 28.5c2.2 11.3 12.1 19.5 23.6 19.5H488c13.3 0 24 10.7 24 24s-10.7 24-24 24H199.7c-34.6 0-64.3-24.6-70.7-58.5L77.4 54.5c-.7-3.8-4-6.5-7.9-6.5H24C10.7 48 0 37.3 0 24zM128 464a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm336-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96zM252 160c0 11 9 20 20 20h44v44c0 11 9 20 20 20s20-9 20-20V180h44c11 0 20-9 20-20s-9-20-20-20H356V96c0-11-9-20-20-20s-20 9-20 20v44H272c-11 0-20 9-20 20z" fill="currentColor"></path></svg></a></div>
</div>
</div></div> </div>
</div>
<div class="clear"></div>
