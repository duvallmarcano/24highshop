---
title: "Disposable Face Mask - 24High"
...
<script>
    ...
    dataLayer.push({
        event: "view_item",
        ecommerce: {"items":[{"quantity":1,"price":0.35,"item_name":"Mondmasker","item_id":"9107668"}],"currency":"EUR","value":0.35}    });
...
<script type="application/ld+json">
    {
        ...
        "image": "https://www.24high.com/images/articles/image.php?id=1268&w=300&h=300",
        "description": "A disposable face mask for sterile cultivation is a simple but important tool when working with mushroom mycelium. During inoculation, transfers, or handling cultivation materials, the mask helps reduce contamination caused by breathing, saliva droplets, and airborne particles.\nWhen working sterile, preventing unwanted bacteria and molds is just as important as using good substrate or high-quality spores.\nWhat is a face mask for sterile cultivation?\nThis face mask is intended for use during cultivation tasks where hygiene is essential, such as inoculating substrate, working with spore syringes, or handling liquid culture. Wearing a mask reduces the chance that microorganisms from the air or breathing come into contact with the cultivation material.\nWhy use it for mushroom cultivation?\nMany contaminations occur unintentionally through talking, breathing, or coughing while working. A face mask adds an extra layer of protection and is therefore often used in combination with gloves, alcohol wipes, and a clean workspace.\n\nReduces the risk of contamination\nSupports sterile and controlled working conditions\nEasy and comfortable to use\nSuitable for beginners and experienced growers\n\nHow do you use the face mask?\nPut on the face mask before starting any cultivation work. Make sure both nose and mouth are fully covered and avoid touching the mask while working. Combine its use with proper hand hygiene and a clean workspace for best results.\nWho is this face mask suitable for?\nThis face mask is suitable for anyone involved in:\n\nInoculating mushroom substrate\nWorking with spore syringes or liquid culture\nHome or hobby mushroom cultivation\nMycology experiments where hygiene is important\n\nSafety &amp; points of attention\nThe face mask is intended as a hygienic aid and does not replace a fully sterile environment. Whenever possible, also use gloves and disinfectants and work in a calm, clean space.\nFrequently asked questions about face masks in mushroom cultivation\n\n Is a face mask really necessary for mushroom cultivation? \u25bc \n\nIt is not mandatory, but many growers use a face mask to minimize the risk of contamination, especially during sterile procedures.\n\n\n Can this face mask be reused? \u25bc \n\nThis type of mask is usually intended for single use. For optimal hygiene, it is recommended to use a clean mask for each cultivation session.\n\n\n What is the best way to combine a face mask? \u25bc \n\nMany users combine a face mask with gloves, alcohol wipes, and a clean workspace for the most sterile working method possible.\n\n\n\nvar acc = document.getElementsByClassName(\"accordion\");\nfor (var i = 0; i < acc.length; i++) {\n  acc[i].addEventListener(\"click\", function() {\n    this.classList.toggle(\"active\");\n    var panel = this.closest(\"p\").nextElementSibling;\n    var arrow = this.querySelector(\"span\");\n    if (panel.style.display === \"block\") {\n      panel.style.display = \"none\";\n      arrow.style.transform = \"rotate(0deg)\";\n    } else {\n      panel.style.display = \"block\";\n      arrow.style.transform = \"rotate(180deg)\";\n    }\n  });\n}\n\n\n",
         "sku": "9107668",
        "gtin13": "",
        "mpn": "11915",
        "offers": {
            ...
            "url": "https://www.24high.com/en/article/9107668-disposable-face-mask?setlang=en&article=9107668-disposable-face-mask",
            "seller": {
                "@type": "Organization",
                "name": "24High"
            }
...
<div class="content">
<h1 class="h1 h1--line" style="color: rgb(101,101,101);">Disposable Face Mask</h1>
...
<img alt="Disposable Face Mask" class="imagebox__mainimage" id="main-product-image" src="../../images/articles/image.php@id=1268&amp;w=1000&amp;h=1000">
<div id="interactive-viewer-container" style="display: none; width: 100%; height: 100%;"></div>
</img></div>
<div class="imagebox__thumbscontainer">
<div class="imagebox__thumbnail" data-url="https://www.24high.com/images/articles/image.php?id=1268&amp;w=1000&amp;h=1000"> <img alt="" src="../../images/articles/image.php@id=1268&amp;w=200&amp;h=200"/></div> </div>
</div>
</div>
<div class="columns__column columns__column--grow" style="padding-left: 10px;">
<div class="fx fx--ai-center">
<a class="a a--hover-primary fx__i" href="9107668-disposable-face-mask.html#" onclick="$('#reviewtabbtn').click().get(0).scrollIntoView();
...
<div class="fx__i">Article number: 9107668</div>
</div>
<br/>
<div id="articlePrice">
<span class="text-bold font-2x">€ 0,35</span> (Incl.VAT)            </div>
<br/><br/>
<br>
<div id="articleStockStatus"><i class="fa fa-check success"></i> In stock</div>
<br/>
<select class="input hidden" id="selectVariant" name="variation"><option value="9107668">Disposable Face Mask</option></select>
<div class="fx">
...
<h2><span style="color: #34495e;">Frequently asked questions about face masks in mushroom cultivation</span></h2>
<div itemprop="mainEntity" itemscope="" itemtype="https://schema.org/Question">
<p><button class="accordion" style="background-color: #eee; color: #444; cursor: pointer; padding: 18px; width: 100%; border: none; text-align: left; outline: none; font-size: 15px; transition: 0.4s; position: relative;"> <strong itemprop="name">Is a face mask really necessary for mushroom cultivation?</strong> <span style="position: absolute; right: 18px; transition: transform 0.4s;">▼</span> </button></p>
...
<p itemprop="text">It is not mandatory, but many growers use a face mask to minimize the risk of contamination, especially during sterile procedures.</p>
</div>
<div itemprop="mainEntity" itemscope="" itemtype="https://schema.org/Question">
<p><button class="accordion" style="background-color: #eee; color: #444; cursor: pointer; padding: 18px; width: 100%; border: none; text-align: left; outline: none; font-size: 15px; transition: 0.4s; position: relative;"> <strong itemprop="name">Can this face mask be reused?</strong> <span style="position: absolute; right: 18px; transition: transform 0.4s;">▼</span> </button></p>
<div class="panel" itemprop="acceptedAnswer" itemscope="" itemtype="https://schema.org/Answer" style="padding: 0 18px; display: none; background-color: white; overflow: hidden;">
<p itemprop="text">This type of mask is usually intended for single use. For optimal hygiene, it is recommended to use a clean mask for each cultivation session.</p>
</div>
<div itemprop="mainEntity" itemscope="" itemtype="https://schema.org/Question">
<p><button class="accordion" style="background-color: #eee; color: #444; cursor: pointer; padding: 18px; width: 100%; border: none; text-align: left; outline: none; font-size: 15px; transition: 0.4s; position: relative;"> <strong itemprop="name">What is the best way to combine a face mask?</strong> <span style="position: absolute; right: 18px; transition: transform 0.4s;">▼</span> </button></p>
<div class="panel" itemprop="acceptedAnswer" itemscope="" itemtype="https://schema.org/Answer" style="padding: 0 18px; display: none; background-color: white; overflow: hidden;">
<p itemprop="text">Many users combine a face mask with gloves, alcohol wipes, and a clean workspace for the most sterile working method possible.</p>
</div>
</div>
<script>
var acc = document.getElementsByClassName("accordion");
...
<div class="article__actions"><a aria-label="Product Tweezers" class="article__button btn btn--secondary btn--block dialog-dismiss" href="5209100-tweezers.html"><svg aria-hidden="true" class="svg-inline--fa fa-info-circle fa-fw" data-fa-i2svg="" data-icon="info-circle" data-prefix="fas" focusable="false" role="img" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" fill="currentColor"></path></svg></a><a aria-label="Order Tweezers" class="article__button btn btn--primary btn--block addArticleToCart dialog-dismiss" data-articlenumber="5209100" href="9107668-disposable-face-mask.html#"><svg aria-hidden="true" class="svg-inline--fa fa-cart-plus fa-fw" data-fa-i2svg="" data-icon="cart-plus" data-prefix="fas" focusable="false" role="img" viewbox="0 0 576 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 24C0 10.7 10.7 0 24 0H69.5c22 0 41.5 12.8 50.6 32h411c26.3 0 45.5 25 38.6 50.4l-41 152.3c-8.5 31.4-37 53.3-69.5 53.3H170.7l5.4 28.5c2.2 11.3 12.1 19.5 23.6 19.5H488c13.3 0 24 10.7 24 24s-10.7 24-24 24H199.7c-34.6 0-64.3-24.6-70.7-58.5L77.4 54.5c-.7-3.8-4-6.5-7.9-6.5H24C10.7 48 0 37.3 0 24zM128 464a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm336-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96zM252 160c0 11 9 20 20 20h44v44c0 11 9 20 20 20s20-9 20-20V180h44c11 0 20-9 20-20s-9-20-20-20H356V96c0-11-9-20-20-20s-20 9-20 20v44H272c-11 0-20 9-20 20z" fill="currentColor"></path></svg></a></div>
</div>
...
<div class="article__actions"><a aria-label="Product Your Psilocybin Mushroom Companion " class="article__button btn btn--secondary btn--block dialog-dismiss" href="2210184-your-psilocybin-mushroom-companion.html"><svg aria-hidden="true" class="svg-inline--fa fa-info-circle fa-fw" data-fa-i2svg="" data-icon="info-circle" data-prefix="fas" focusable="false" role="img" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" fill="currentColor"></path></svg></a><a aria-label="Order Your Psilocybin Mushroom Companion " class="article__button btn btn--primary btn--block addArticleToCart dialog-dismiss" data-articlenumber="2210184" href="9107668-disposable-face-mask.html#"><svg aria-hidden="true" class="svg-inline--fa fa-cart-plus fa-fw" data-fa-i2svg="" data-icon="cart-plus" data-prefix="fas" focusable="false" role="img" viewbox="0 0 576 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 24C0 10.7 10.7 0 24 0H69.5c22 0 41.5 12.8 50.6 32h411c26.3 0 45.5 25 38.6 50.4l-41 152.3c-8.5 31.4-37 53.3-69.5 53.3H170.7l5.4 28.5c2.2 11.3 12.1 19.5 23.6 19.5H488c13.3 0 24 10.7 24 24s-10.7 24-24 24H199.7c-34.6 0-64.3-24.6-70.7-58.5L77.4 54.5c-.7-3.8-4-6.5-7.9-6.5H24C10.7 48 0 37.3 0 24zM128 464a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm336-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96zM252 160c0 11 9 20 20 20h44v44c0 11 9 20 20 20s20-9 20-20V180h44c11 0 20-9 20-20s-9-20-20-20H356V96c0-11-9-20-20-20s-20 9-20 20v44H272c-11 0-20 9-20 20z" fill="currentColor"></path></svg></a></div>
</div>
...
<div class="article__actions"><a aria-label="Product Syringe 10ml - Sterile Packaged" class="article__button btn btn--secondary btn--block dialog-dismiss" href="3206182-syringe-10ml-sterile-packaged.html"><svg aria-hidden="true" class="svg-inline--fa fa-info-circle fa-fw" data-fa-i2svg="" data-icon="info-circle" data-prefix="fas" focusable="false" role="img" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" fill="currentColor"></path></svg></a><a aria-label="Order Syringe 10ml - Sterile Packaged" class="article__button btn btn--primary btn--block addArticleToCart dialog-dismiss" data-articlenumber="3206182" href="9107668-disposable-face-mask.html#"><svg aria-hidden="true" class="svg-inline--fa fa-cart-plus fa-fw" data-fa-i2svg="" data-icon="cart-plus" data-prefix="fas" focusable="false" role="img" viewbox="0 0 576 512" xmlns="http://www.w3.org/2000/svg"><path d="M0 24C0 10.7 10.7 0 24 0H69.5c22 0 41.5 12.8 50.6 32h411c26.3 0 45.5 25 38.6 50.4l-41 152.3c-8.5 31.4-37 53.3-69.5 53.3H170.7l5.4 28.5c2.2 11.3 12.1 19.5 23.6 19.5H488c13.3 0 24 10.7 24 24s-10.7 24-24 24H199.7c-34.6 0-64.3-24.6-70.7-58.5L77.4 54.5c-.7-3.8-4-6.5-7.9-6.5H24C10.7 48 0 37.3 0 24zM128 464a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm336-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96zM252 160c0 11 9 20 20 20h44v44c0 11 9 20 20 20s20-9 20-20V180h44c11 0 20-9 20-20s-9-20-20-20H356V96c0-11-9-20-20-20s-20 9-20 20v44H272c-11 0-20 9-20 20z" fill="currentColor"></path></svg></a></div>
</div>
