...
```
scripts/                 one-off pipeline that turns the scraped mirror into content
...
npm run normalize:images   # re-run the image rename pass
npm run extract            # re-derive src/content from ../www.24high.com
```
